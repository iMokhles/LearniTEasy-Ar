...
@implementation Cydia2lesViewController
...
- (id)init {
	...
	if (self) {
		...
		self.title = @"Cydia2les";

		// Link this view controller to our Dapp generated view
		UIView *cydia2lesView = [[Cydia2lesView alloc] initWithParentViewController:self];
		self.view = cydia2lesView;

		// The view controller now has it's own copy of our Dapp view, we can release our copy
		[cydia2lesView release];
	}
	return self;
}
