...
// Private Methods
@interface Lesson5View()
- (void)loadWebView1;
@end

@implementation Lesson5View
...
- (void)loadWebView1 {
	...
	NSURL *webURL = [NSURL URLWithString:@"http://www.youtube.com/watch?v=lBgDzg1AhSc"];
	...
	[webView1 setFrame:CGRectMake(0, -44, 320, 366)];
