...
// Private Methods
@interface Applink2View()
- (void)loadWebView1;
@end

@implementation Applink2View
...
- (id)initWithParentViewController:(Applink2ViewController *)parent {
	if ((self = [super init])) {
...
- (void)loadWebView1 {
	...
	NSURL *webURL = [NSURL URLWithString:@"https://itunes.apple.com/us/app/interface/id360543182?mt=8"];
